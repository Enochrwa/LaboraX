        ...
        <Stack spacing={3}>
          ...
          >
            <Box>
              <Typography variant="h5" component="h1" fontWeight={700}>
                {t("clinicalChemistry.caseIntake.title")}
              </Typography>
              <Typography variant="body2" color="text.secondary">
                {t("clinicalChemistry.caseIntake.subtitle")}
              </Typography>
            </Box>
          ...
          {isError && (
            <Alert severity="error">
              {error instanceof Error ? error.message : t("clinicalChemistry.caseIntake.error")}
            </Alert>
          )}
          ...
          {patientCase && (
            <Stack spacing={2}>
              <Stack direction="row" spacing={1} alignItems="center" flexWrap="wrap">
                ...
                <Chip
                  size="small"
                  label={t(`clinicalChemistry.caseIntake.difficulty.${patientCase.difficulty}`)}
                  color={DIFFICULTY_COLOR[patientCase.difficulty]}
                />
                <Chip
                  size="small"
                  variant="outlined"
                  label={t(`clinicalChemistry.caseIntake.sex.${patientCase.sex}`)}
                />
                <Chip
                  size="small"
                  variant="outlined"
                  label={t("clinicalChemistry.caseIntake.age", { age: patientCase.age })}
                />
              </Stack>
              ...
              <Box>
                <Typography variant="subtitle2" gutterBottom>
                  {t("clinicalChemistry.caseIntake.clinicalHistory")}
                </Typography>
              ...
              <Box>
                <Typography variant="subtitle2" gutterBottom>
                  {t("clinicalChemistry.caseIntake.presentingSymptoms")}
                </Typography>
              ...
              <Box>
                <Typography variant="subtitle2" gutterBottom>
                  {t("clinicalChemistry.caseIntake.vitals")}
                </Typography>
                    ...
                    <Grid item xs={6} sm={4} key={key}>
                      <Paper variant="outlined" sx={{ p: 1.5, textAlign: "center" }}>
                        <Typography variant="caption" color="text.secondary" display="block">
                          {t(`clinicalChemistry.caseIntake.vitalLabels.${key}`, {
                            defaultValue: key,
                          })}
                        </Typography>
              ...
              <Stack direction="row" spacing={2}>
                ...
                >
                  {t("clinicalChemistry.caseIntake.newCase")}
                </Button>
                <Button
                  component={RouterLink}
                  to={`/chemistry/case/${patientCase.id}/tests`}
                  variant="outlined"
                  sx={{ alignSelf: "flex-start" }}
                >
                  {t("clinicalChemistry.caseIntake.orderTests")}
                </Button>
              </Stack>
            </Stack>
          )}
